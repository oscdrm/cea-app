        ...
        <div class="col-lg-9">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <strong>Crear nuevo tipo de inscripción</strong>
                </li>
            </ol>
        </div>
    </div>
...
<div class="wrapper wrapper-content animated fadeInRight">
        ...
        <div class="row">
            ...
            <div class="ibox-content shad col-12">
                <h4>Crear nuevo tipo de inscripcion</h4>
                ...
                <div class="ibox-content">
                    <form method="post" action="{{url('/tipoInscripcion')}}" id="form" class="form-horizontal">
                        @csrf
