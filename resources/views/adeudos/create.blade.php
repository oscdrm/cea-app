        ...
        <div class="col-lg-9">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <strong>Registrar nuevo adeudo</strong>
                </li>
            </ol>
        </div>
    </div>
...
<div class="wrapper wrapper-content animated fadeInRight">
        ...
        <div class="ibox-content shad">
            ...
            @endif
            <form method="post" action="{{url('/adeudos')}}" class="form-horizontal form-disabled" enctype="multipart/form-data">
                @csrf
